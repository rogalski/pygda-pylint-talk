...
"""
Original code:
https://github.com/quantifiedcode/python-ast-visualizer

To run an example:
python3 astvisualizer.py -f simple_module.py
"""
import numbers
import optparse
import re
...
class GraphRenderer:
    ...
    def render(self, data, *, label=None):
        ...
        # display the graph
        graph.format = "png"
        graph.view(filename='ast', cleanup=True)
